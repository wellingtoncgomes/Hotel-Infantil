module.exports = {
  ...
  create: (pool, data, callback) => {
    const sql =
      "INSERT INTO Atividades (nome, descricao, faixa_etaria, imagem) VALUES ($1, $2, $3, $4)";
    const values = [
      data.nome,
      data.descricao,
      data.faixa_etaria,
  ...
  update: (pool, data, callback) => {
    const sql =
      "UPDATE Atividades SET nome = $1, descricao = $2, faixa_etaria = $3, imagem = $4 WHERE id_atividade = $5";
    const values = [
      data.nome,
      data.descricao,
      data.faixa_etaria,
