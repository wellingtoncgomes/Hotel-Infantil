...
const {faleConosco,sendMessage} = require('../controllers/controllerfale-conosco');
const { validarUsuario } = require('../../config/validarUser');
const { authenticateUser, cadastrarUsuario, mostrarCadastro, mostrarLogin } = require('../controllers/controllerAuth');
